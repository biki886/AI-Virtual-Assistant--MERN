  ...
  return (
    ...
    >
      <form
        ...
        className="w-[90%] h-[600px] max-w-[500px] bg-[#0000004b] backdrop-blur shadow-lg shadow-black flex flex-col items-center justify-center gap-[20px] rounded-xl px-[20px]"
      >
        ...
        <p className="text-white text-[14px] typing-text overflow-hidden whitespace-nowrap border-r-2 border-white">
          Create your personal virtual assistant
        </p>
